...
public class Tank_SideGun_FieldofView : MonoBehaviour
{
    ...
    private Tank_SideGun_Behavior sideGun;
    ...
    void Start()
    {
        ...
        targetMask = LayerMask.GetMask("Enemy_Infantry"); // seta a laymask pra mask do inspector
        obstacleMask = LayerMask.GetMask("Obstacles"); // seta a laymask pra mask do inspector

        sideGun = GetComponentInChildren<Tank_SideGun_Behavior>();
