...
public class Tank_Enemy_Turret_FieldofView : MonoBehaviour
{
    ...
    private Tank_Enemy_Turret_Behavior turret;
    ...
    void Start()
    {
        ...
        targetMask = LayerMask.GetMask("Player_Tanks"); // seta a laymask pra mask do inspector
        obstacleMask = LayerMask.GetMask("Obstacles"); // seta a laymask pra mask do inspector

        turret = GetComponentInChildren<Tank_Enemy_Turret_Behavior>();
