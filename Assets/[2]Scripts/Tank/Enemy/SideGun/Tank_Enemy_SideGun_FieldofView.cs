...
public class Tank_Enemy_SideGun_FieldofView : MonoBehaviour
{
    ...
    private Tank_Enemy_SideGun_Behavior sideGun;
    ...
    void Start()
    {
        ...
        targetMask = LayerMask.GetMask("Player_Infantry"); // seta a laymask pra mask do inspector
        obstacleMask = LayerMask.GetMask("Obstacles"); // seta a laymask pra mask do inspector

        sideGun = GetComponentInChildren<Tank_Enemy_SideGun_Behavior>();
    ...
    void Update()
    {
        ...
        else // ira olhar para o primeiro alvo da list
        {
            ...
            sideGun.targetForTurret = visibleTargets[0];
