...
public class Enemy_SideGun_Bullet : MonoBehaviour
{
    #region Variables
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (target != null || collision.gameObject.tag == "PlayerInfantry") // testa se o alvo for diferente de vazio e um inimigo
        {
